...
namespace OrderPlatForm.Controllers
{
    public class MoneyManagerController : BaseController
    {
        ...
        /// </summary>
        /// <returns></returns>
        //public JsonResult QueryRechargeInfo()
        //{
        //    RequestUser();
        ...
        //    var result = IDDC.ITEM(Argument, value);
        //    string UserName = GetParams("UserName");
        //    int MoneyType = int.Parse(GetParams("MoneyType"));
        //    if (!string.IsNullOrEmpty(GetParams("starttime")) && !string.IsNullOrEmpty(GetParams("endtime")))
        //    {
        //        DateTime starttime = DateTime.Parse(GetParams("starttime"));
        //        DateTime endtime = DateTime.Parse(GetParams("endtime"));
        //        switch (result.Key)
        //        {
        //            //mode字段1:表示充值,2:表示提现
        //            case "用户名":
        //                rpd = ICC.QueryMoney(pageIndex, pageSize, o => o.StartTime >= starttime && o.EndTime <= endtime && o.UserName.Contains(UserName) && o.MoneyType == MoneyType && o.Mode == 1, o => o.UserName);
        //                break;
        //            case "手机号":
        //                rpd = ICC.QueryMoney(pageIndex, pageSize, o => o.StartTime >= starttime && o.EndTime <= endtime && o.Email.Contains(UserName) && o.MoneyType == MoneyType && o.Mode == 1, o => o.UserName);
        //                break;
        //            case "邮箱":
        //                rpd = ICC.QueryMoney(pageIndex, pageSize, o => o.StartTime >= starttime && o.EndTime <= endtime && o.PhoneNumber.Contains(UserName) && o.MoneyType == MoneyType && o.Mode == 1, o => o.UserName);
        //                break;
        //        }
        //    }
        //    else
        ...
        //            //mode字段1:表示充值,2:表示提现
        //            case "用户名":
        //                rpd = ICC.QueryMoney(pageIndex, pageSize, o => o.UserName.Contains(UserName) && o.MoneyType == MoneyType && o.Mode == 1, o => o.UserName);
        //                break;
        //            case "手机号":
        //                rpd = ICC.QueryMoney(pageIndex, pageSize, o => o.Email.Contains(UserName) && o.MoneyType == MoneyType && o.Mode == 1, o => o.UserName);
        //                break;
        //            case "邮箱":
        //                rpd = ICC.QueryMoney(pageIndex, pageSize, o => o.PhoneNumber.Contains(UserName) && o.MoneyType == MoneyType && o.Mode == 1, o => o.UserName);
        //                break;
        //        }
        //    }
        //    if (rpd.total!=0)
        ...
        /// </summary>
        /// <returns></returns>
        //public JsonResult QueryWithdrawalInfo()
        //{
        //    RequestUser();
        //    int pageIndex = int.Parse(GetParams("pageIndex"));
        //    int pageSize = int.Parse(GetParams("pageSize"));
        ...
        //            //mode字段1:表示充值,2:表示提现
        //            case "用户名":
        //                rpd = ICC.QueryMoney(pageIndex, pageSize, o => o.StartTime >= starttime && o.EndTime <= endtime && o.UserName.Contains(UserName) && o.MoneyType == MoneyType && o.Mode == 2, o => o.UserName);
        //                break;
        //            case "邮箱":
        //                rpd = ICC.QueryMoney(pageIndex, pageSize, o => o.StartTime >= starttime && o.EndTime <= endtime && o.Email.Contains(UserName) && o.MoneyType == MoneyType && o.Mode == 2, o => o.UserName);
        //                break;
        //            case "手机号":
        //                rpd = ICC.QueryMoney(pageIndex, pageSize, o => o.StartTime >= starttime && o.EndTime <= endtime && o.PhoneNumber.Contains(UserName) && o.MoneyType == MoneyType && o.Mode == 2, o => o.UserName);
        //                break;
        //        }
        //    }
        //    else
        ...
        //            //mode字段1:表示充值,2:表示提现
        //            case "用户名":
        //                rpd = ICC.QueryMoney(pageIndex, pageSize, o => o.UserName.Contains(UserName) && o.MoneyType == MoneyType && o.Mode == 2, o => o.UserName);
        //                break;
        //            case "邮箱":
        //                rpd = ICC.QueryMoney(pageIndex, pageSize, o => o.Email.Contains(UserName) && o.MoneyType == MoneyType && o.Mode == 2, o => o.UserName);
        //                break;
        //            case "手机号":
        //                rpd = ICC.QueryMoney(pageIndex, pageSize, o => o.PhoneNumber.Contains(UserName) && o.MoneyType == MoneyType && o.Mode == 2, o => o.UserName);
        //                break;
        //        }
        //    }
        //    if (rpd.total != 0)
